...
pathSANtoYOU = pathLen('SAN', intersectFirst) + pathLen('YOU', intersectFirst) - 2 # -2 because "Between the objects they are orbiting - not between YOU and SAN."
print(pathSANtoYOU)